...
export class Backend implements backendInterface {
    ...
    async addFAQ(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async submitConsultation(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitConsultation(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
